#!/bin/bash
# J3 — nocond_joint_uniform
#SBATCH --job-name=J3_nocond_joint_uniform
...
#SBATCH --output=slurm_logs/J3_nocond_joint_uniform_%j.out
#SBATCH --error=slurm_logs/J3_nocond_joint_uniform_%j.err
...
python /cluster/home/da3999/projects/segsynthtemplate/segsynthtemplate/train.py \
    experiment=mthesis/joint_nocond_real \
