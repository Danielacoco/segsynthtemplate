#!/bin/bash
# S5 — dhcp_combined_specialist (fetal + neonatal dHCP)
#SBATCH --job-name=S5_dhcp_combined_specialist
...
#SBATCH --output=slurm_logs/S5_dhcp_combined_specialist_%j.out
#SBATCH --error=slurm_logs/S5_dhcp_combined_specialist_%j.err
...
python /cluster/home/da3999/projects/segsynthtemplate/segsynthtemplate/train.py \
    experiment=mthesis/dhcp_combined_specialist_real \
    ...
    data.datasets.1.bids_path=/data/bach/da3999/neonataldHCP/resampled75/ \
    data.datasets.1.split_file=/data/bach/da3999/neonataldHCP/resampled75/splits_40_10_15_35.csv \
