#!/bin/bash
# J4 — nocond_joint_balanced
#SBATCH --job-name=J4_nocond_joint_balanced
...
#SBATCH --output=slurm_logs/J4_nocond_joint_balanced_%j.out
#SBATCH --error=slurm_logs/J4_nocond_joint_balanced_%j.err
...
python /cluster/home/da3999/projects/segsynthtemplate/segsynthtemplate/train.py \
    experiment=mthesis/joint_nocond_balanced \
    ...
    logger.wandb.name=nocond_joint_balanced
