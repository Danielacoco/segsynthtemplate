#!/bin/bash
# J1 — conemos_joint_uniform (server backup; run locally when possible)
#SBATCH --job-name=J1_conemos_joint_uniform
...
#SBATCH --output=slurm_logs/J1_conemos_joint_uniform_%j.out
#SBATCH --error=slurm_logs/J1_conemos_joint_uniform_%j.err
...
python /cluster/home/da3999/projects/segsynthtemplate/segsynthtemplate/train.py \
    ...
    logger.wandb.name=conemos_joint_uniform
