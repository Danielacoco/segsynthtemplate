...
class Segmentor(LightningModule):
    def __init__(
        self,
        net: torch.nn.Module,
    ...
    def predict_step(self, batch, batch_idx, dataloader_idx=None):
        x, y, names = batch["image"], batch["label"], batch["name"]
    ...
    def training_step(
        ...
        self.log(
            "train/dsc", self.train_dsc, on_step=True, on_epoch=True, prog_bar=True
        )
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        self.log(
            "val/dsc_best", self.val_dsc_best.compute(), sync_dist=True, prog_bar=True
        )
